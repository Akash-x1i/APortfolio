        ...
        <>
          ...
          <div id="home" className="flex flex-col pt-[120px]">
            <Image
              ...
              width={10000}
              alt={"Profile Photo"}
              className="border rounded-full w-[90px] h-[90px] mb-8 border-[#333] dark:border-white"
            ></Image>
            <div data-aos="fade-right" className="">
              <h1 className="text-3xl font-[700] ">Adarsh Raj</h1>
              <p className="mt-1">
                <TypeAnimation
                  sequence={[
                    "Engineer",
            ...
            >
              <Link href={"https://github.com/adarsh07raj"} target="_blank">
                <Button
                  variant={"outline"}
                  size={"sm"}
              ...
              <Link
                href={"https://linkedin.com/in/https://www.linkedin.com/in/adarsh-raj-8ab99b2a6"}
                target="_blank"
              >
                <Button
                  variant={"outline"}
          ...
          <div id="about" className=" flex flex-col pt-[14vh]">
            ...
            >
              Hello! I&apos;m a MCA student at LPU University.
          ...
          <div id="projects" className="flex flex-row pt-[16vh]">
            <h1
              data-aos="fade-right"
              data-aos-anchor-placement="top-bottom"
              className="text-3xl underline decoration-sky-500 dark:decoration-sky-500/80 underline-offset-[5px] decoration-4 tracking-wide antialiased "
            >
              Projects
            </h1>
            <div
          ...
          <div id="connect" className="flex flex-col mt-8 ">
            ...
            <div className="flex flex-col my-2 rounded-xl items-center">
              ...
              <div className="flex">
                ...
                <Link href={"https://github.com/adarsh07raj"}>
                  <Button
                    data-aos="fade-up"
                    data-aos-anchor-placement="top-bottom"
                    data-aos-delay="100"
                ...
                <Link
                  href={
                    "mailto:adarshraj7mar@gmail.com?subject=Hello%20there&body=How%20are%20you%3F"
                  }
                >
                  <Button
                    data-aos="fade-up"
          ...
          <div className="text-sm border-t-2 pt-4 mt-8 text-center dark:text-[#efefef] text-[#333]">
            ...
            <h1 className="mb-6 py-1">
              © 2025 <b className="font-[700] tracking-[1px]">Adarsh Raj</b>
              . All rights reserved.
            </h1>
          </div>
        </>
